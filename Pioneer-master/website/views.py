...
from .models import Student, Driver, Conductor, Bus, Route, Owner, School, Teacher, PBSUser, FeeCollector, Expense
...
def view_expense(request):
    try:
        ...
        raise Http404("No expense Model exists")
